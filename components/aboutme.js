      ...
      <div className="container mx-auto p-5 text-dc-grey dark:text-white">
        ...
        <div className="font-roboto relative md:grid md:grid-flow-row md:grid-cols-2 md:p-4 py-4 md:space-x-4 md:space-y-4">
          <div className="[ AboutMe__Article ][ Intro ] p-4 col-start-1 col-end-1">
            ...
            <p className="[ AboutMe__Text ][ Summary ] font-bold text-lg text-left py-2">
              Hey, I&apos;m {firstName}. I work at {employer} as a {jobTitle}, and aim to continue
              on my journey into the world of technology and learn as many wicked and wonderful
              things as I can!
            </p>
        ...
        <div className="font-roboto relative md:grid md:grid-flow-row md:grid-cols-2 md:p-4 py-4 md:space-x-4 md:space-y-4">
          <div className="[ AboutMe__Article ][ Music ] p-4 col-start-2 col-end-2">
            ...
            <p className="[ AboutMe__Text ] font-bold text-lg text-left py-2">{data.musicText}</p>
