...
const Projects: React.FC = () => {
  ...
  return (
    <div className="container font-roboto mx-auto my-auto">
      ...
      {data?.repositories.map((repo: repositoryData, index: number) => (
        <a key={index} href={repo.html_url} target="_blank" rel="noreferrer">
          <div className="[ Projects ] p-2 m-4 border-2 border-black dark:border-white hover:bg-gray-200 dark:hover:bg-black">
