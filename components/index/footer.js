        ...
        <div className='grid grid-flow-row grid-cols-6 grid-rows-1 gap-6'>
          <div className='self-center text-left col-span-5'>
            <div className='font-mono text-lg font-semibold'>
              ...
              <a
                className='[ Footer-Link ] text-yellow-500 hover:text-yellow-300'
            ...
            <div className='font-mono text-lg font-semibold'>
              Built in{' '}
              <a
                className='[ Footer-Link ] text-pink-500 hover:text-pink-300'
              ...
              . Hosted on{' '}
              <a
                className='[ Footer-Link ] text-green-500 hover:text-green-300'
            ...
            <div className='font-mono text-lg font-semibold'>
              Inspired by{' '}
              <a
                className='[ Footer-Link ] text-indigo-500 hover:text-indigo-300'
