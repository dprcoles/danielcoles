      ...
      <div className='container mx-auto p-5 text-dc-grey'>
        <div className='grid grid-flow-row grid-cols-6 grid-rows-1 gap-6'>
          <div className='self-center text-left col-span-5'>
            <div className='[ Footer-Text ] font-mono text-lg font-semibold'>
              Designed and developed by{' '}
              <a
                className='[ Footer-Text ][ Footer-Link ] text-yellow-500 hover:text-yellow-300'
            ...
            <div className='[ Footer-Text ] font-mono text-lg font-semibold'>
              Built in{' '}
              <a
                className='[ Footer-Text ][ Footer-Link ] text-pink-500 hover:text-pink-300'
              ...
              . Hosted on{' '}
              <a
                className='[ Footer-Text ][ Footer-Link ] text-green-500 hover:text-green-300'
            ...
            <div className='[ Footer-Text ] font-mono text-lg font-semibold'>
              Inspired by{' '}
              <a
                className='[ Footer-Text ][ Footer-Link ] text-indigo-500 hover:text-indigo-300'
