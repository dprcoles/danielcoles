...
export const shuffledColours = (resolvedTheme: string | undefined): NotationColours => {
  const colours: Array<ColourThemeType> = shuffle(
    resolvedTheme === "dark" ? DARK_THEME_COLOURS : LIGHT_THEME_COLOURS
  )
